"""
تست نهایی مدل Comyco (تقلیدی) روی مجموعه داده Cooked (TEST SET)
"""
import sys, os
...
print("=" * 80)
print("🧪 FINAL TEST on COOKED_TRACES SET (Comyco-style Model) 🧪")
print("=" * 80)
...
for ep in tqdm(range(num_test_episodes), desc="Eval (Comyco Cooked)"):
...
print("\n" + "=" * 80)
print("📊 FINAL RESULTS (Comyco Model on COOKED_TRACES Set)")
print("=" * 80)
