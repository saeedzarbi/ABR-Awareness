# scripts/setup/split_fcc_traces_auto.py
...
def split_fcc_traces_from_directory(fcc_dir, output_dir, 
    ...
    Args:
        fcc_dir: Directory containing FCC trace files
    ...
    for file in os.listdir(fcc_dir):
        # Skip directories and non-trace files
    ...
    if not trace_files:
        ...
        print(f"💡 Make sure your trace files are in this directory")
        return None, None, None
    ...
    print("📋 Sample traces:")
    for i, trace in enumerate(trace_files[:5]):
        print(f"   {i+1}. {trace}")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        fcc_directory = 'data/network_traces/fcc'
