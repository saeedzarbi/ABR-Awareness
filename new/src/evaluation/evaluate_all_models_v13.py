...
def _soft_guard_cfg() -> ShieldConfigV13:
    return ShieldConfigV13(
        ...
        emergency_zero=_env_bool("ABR_V13_EMERGENCY_ZERO", True),
        emergency_zero_stall_s=_env_float("ABR_V13_EMERGENCY_ZERO_STALL", 1.25),
...
def _tight_guard_cfg() -> ShieldConfigV13:
    return ShieldConfigV13(
        ...
        emergency_zero=_env_bool("ABR_V13_TIGHT_EMERGENCY_ZERO", True),
        emergency_zero_stall_s=_env_float("ABR_V13_TIGHT_EMERGENCY_ZERO_STALL", 1.25),
